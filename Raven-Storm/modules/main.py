# 2020
# The Raven-Storm Toolkit was programmed and developed by LinuxPhantom.
# The Raven-Storm Toolkit is published under the MIT Licence.
# The Raven-Storm Toolkit is based on the CLIF-Framework.
# The CLIF-Framework is programmed and developed by LinuxPhantom.
...
C_BoStress-Testing-Toolkit by LinuxPhantom (c) | MIT 2023
Based on the CLIF Framework by LinuxPhantom (c) | MIT 2023C_W
...
C_Bo-----------------------------------------------------------C_W""")
	...
	def upgrade():
		try:
			chdir("/tmp")
			system("sudo git clone https://github.com/LinuxPhantom/Raven-Storm.git")
